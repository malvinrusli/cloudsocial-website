...
export default async function WebArchitecturePage({ params }) {
    ...
    return (
        <main className="min-h-screen bg-white">
            <Navbar lang={lang} />
            <PageHero
                title={lang === 'id' ? "Arsitektur Web" : "Web Architecture"}
                subtitle={lang === 'id' ? "Membangun fondasi digital yang cepat, aman, dan skalabel untuk portofolio real estat Anda." : "Building fast, secure, and scalable digital foundations for your real estate portfolio."}
