...
export default async function AIStrategyPage({ params }) {
    ...
    return (
        <main className="min-h-screen bg-white">
            ...
            <PageHero
                title={lang === 'id' ? "Agen AI Otonom" : "Autonomous AI Agents"}
                subtitle={lang === 'id' ? "Mengotomatiskan interaksi pelanggan dan kualifikasi prospek dengan kecerdasan tingkat lanjut." : "Automating customer interactions and lead qualification with advanced intelligence."}
