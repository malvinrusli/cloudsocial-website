...
export default async function AEOPage({ params }) {
    ...
    return (
        <main className="min-h-screen bg-white">
            <Navbar lang={lang} />
            <PageHero
                title={lang === 'id' ? "Visibilitas AI & GEO" : "AI Visibility & GEO"}
                subtitle={lang === 'id' ? "Optimasi untuk Model Bahasa Besar (LLM) dan mesin pencari generasi berikutnya." : "Optimizing for Large Language Models and the next generation of search engine."}
                tagline="AI Search Optimization"
            />
            <AlternatingSection lang={lang} serviceType="aeo" />
            <Footer lang={lang} />
        </main>
    );
}
