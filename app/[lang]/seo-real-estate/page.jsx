...
export default async function SEOPage({ params }) {
    ...
    return (
        <main className="min-h-screen bg-white">
            ...
            <PageHero
                lang={lang}
                title={lang === 'id' ? "Otoritas Pencarian" : "Search Authority"}
                subtitle={lang === 'id' ? "Mendominasi hasil pencarian real estat melalui infrastruktur teknis dan keunggulan konten." : "Dominating real estate search results through technical infrastructure and content excellence."}
                tagline="SEO Infrastructure"
            />
            <Footer lang={lang} />
        </main>
    );
