...
const Philosophy = () => {
    ...
    return (
        <section
            ref={containerRef}
            className="relative w-full py-40 overflow-hidden flex items-center justify-center min-h-[80vh] px-8 md:px-16 border-y border-gray-100 bg-[#FAFAFA]"
        >
            ...
            <div className="relative z-10 w-full max-w-5xl flex flex-col items-center text-center">
                <p className="text-textDark/80 font-sans tracking-widest text-sm md:text-base mb-10 font-medium bg-white px-6 py-2 full border border-gray-100 shadow-sm">
